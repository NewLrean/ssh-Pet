...
<div class="box w1180">
	...
	<p style="width: 100%;text-align: center;font-size: 20px;margin-top: 20px;"> 您正在退出登录</p>
	<p style="width: 100%;text-align: center;font-size: 15px;margin-top: 20px;">
	<font id="id8" size="6">3</font>秒钟后跳转登录或<a  href="${ctx}/login.jsp" style="color: #f00;font-size: 20px;">点击我直接跳转</a></p>
